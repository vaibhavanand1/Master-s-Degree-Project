...
#SBATCH --job-name=run_mch
#SBATCH --error=run_mch_error
#SBATCH --output=run_mch_out
#SBATCH --partition=standard  

module load compiler/intel/2018.2.199
module load compiler/gcc/7.3.0
source /home/pupadhyay21/vaibhav/gromacs_2019/bin/GMXRC
...
cd /scratch/pupadhyay21/vaibhav/MT_Charmm/
