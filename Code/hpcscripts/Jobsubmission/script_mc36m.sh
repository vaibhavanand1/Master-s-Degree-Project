...
#SBATCH --job-name=run_mc36m
#SBATCH --error=run_mc36m_error
#SBATCH --output=run_mc36m_out
#SBATCH --partition=standard  

module load compiler/intel/2020.2.254
module load compiler/gcc/8.3.0
source /home/dvaibhav/gromacs_2019_gpu/bin/GMXRC
...
cd /scratch/dvaibhav/vaibhav/UBA/MT_C36m/

# cd /scratch/dvaibhav/vaibhav/Replicate/MT_C36m/

# REMOVING CRYSTAL-WATER MOLECULES 
# grep -v HOH uba1_mt.pdb > uba1_mt_clean.pdb
